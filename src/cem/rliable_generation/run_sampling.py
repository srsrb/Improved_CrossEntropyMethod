...
def sample_jsons_yaml(ls_cfg_paths,ls_envs_names,specification):
    ...
    json  = JSON_Generator.JSON_Generator(ls_envs_names,specification)
...
def sample_these_configs( ls_names,directory="./configs/",specification  = ""):
    ...
    sample_jsons_yaml(ls_cfg_paths,ls_env_names,specification)
