...
def test_json():
    sum  =  JSON_Summary(['tic-tac','tu_craques'],"demo","commentaire")
    sum.add_scores_to_environment('tic-tac',[0,0,0,0,0,0])
    sum.add_scores_to_environment('tu_craques',[1,1,1,1,1,1,1,1])
    sum.end_sampling()
test_json()
