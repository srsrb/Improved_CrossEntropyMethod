...
def CEM(test_function,merge, EXPERIMENT, CEMi , centroid , seed , sigma , noise_multiplier , max_epochs , pop_size , elites_nb ) :
        """Returns:
        ...
        for epoch in range(max_epochs):
            ...
            weights = matrix.generate_weights(centroid, size)
            ...
            if merge :
                ...
                scores = np.concatenate((scores,scores_CEM), axis=0)
...
def CEM_CEMir_merged(test_function,merge, EXPERIMENT, CEMi , centroid , seed , sigma , noise_multiplier , max_epochs , pop_size , elites_nb ) :
        """Returns:
        (all_weights,all_centroids,all_covs)
        """
