...
def plot_cem_on_function(f, folder_plots ="plots_",folder_analysis ="analysis_",
    ...
    if EXPERIMENT: # If we want to test the variant of the CEm that we experiment on
        cem_variant  =  'iResize' 
    elif  CEMi :
        cem_variant = 'i' 
    else:
...
if __name__=='__main__':
    ...
    #plot_cem_on_function(score_function,show_points=0,show_plot=True,show_ellipsoids=0,show_centroids=1)